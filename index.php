...
// if ($result1 === false) {
//     // Handle the SQL error here, for example:
//     die("SQL error: " . $conn->error);
// }

// if ($result1->num_rows > 0) {
//     $row = $result1->fetch_assoc();
//     // Now you can safely access $row['id'] or other fields
// } else {
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-lg"><b>An automated tool for shortlisting</b> online recruitment applications</span>
    </a>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center index-head">
            <h1><strong>An automated tool for shortlisting online recruitment applications</strong></h1>
          ...
          */
          ...
          if($result->num_rows > 0) {
            ...
            <div class="attachment-block clearfix">
              <img class="attachment-img" src="img/photo11.png" alt="Attachment Image">
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2023 <a href="#">CELESTINE NEKESA</a>.</strong> All rights reserved.
    </div>
  </footer>
