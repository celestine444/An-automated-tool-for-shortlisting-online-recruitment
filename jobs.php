              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked tree" data-widget="tree">
                  <li class="treeview menu-open">
                    <a href="#"><i class="fa fa-plane text-red"></i> Cities in Kenya <span class="pull-right"><i class="fa fa-angle-down pull-right"></i></span></a>
                    <ul class="treeview-menu">
                      <li><a href=""  class="citySearch" data-target="Nairobi"><i class="fa fa-circle-o text-yellow"></i> Nairobi</a></li>
                      <li><a href="" class="citySearch" data-target="Mombasa"><i class="fa fa-circle-o text-yellow"></i> Mombasa</a></li>
                      <li><a href=""  class="citySearch" data-target="Kisumu"><i class="fa fa-circle-o text-yellow"></i> Kisumu</a></li>
                      <li><a href="" class="citySearch" data-target="Nakuru"><i class="fa fa-circle-o text-yellow"></i>Nakuru</a></li></ul>
                  </li>
                  <li class="treeview menu-open">
