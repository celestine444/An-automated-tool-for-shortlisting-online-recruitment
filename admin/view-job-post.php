        ...
        <div class="row">          
          <div class="col-md-9 bg-white padding-2">
            ...
            <div>
                  ...
                  <p><span class="margin-right-10"><i class="fa fa-location-arrow text-green"></i> <?php echo $row['qualification']; ?> </span> </p>      
                  <p><i class="fa fa-location-arrow text-green"></i> <?php echo $row['skills']; ?></p>        
                </div>
            <div>
              <?php 
