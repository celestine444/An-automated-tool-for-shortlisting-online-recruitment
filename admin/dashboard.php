...
<div class="wrapper">
        ...
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li><a href="shortlisted.php"><i class="fa fa-building"></i> Shortlisted</a></li>
                  <li><a href="unqualified.php"><i class="fa fa-building"></i> Unqualified</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="info-box bg-c-yellow">
                  <span class="info-box-icon bg-ygreen"><i class="ion ion-ios-browsers"></i></span>
                  <div class="info-box-content">
                    <span class="info-box-text">Shortlisted</span>
                    <?php
                      $sql = "SELECT * FROM users WHERE qualification = 'Bachelor\'s Degree'
                      or qualification  = 'Masters' or  qualification  = 'PHD' 
                      or qualification  = 'Bachelors Degree'";
                      $result = $conn->query($sql);
                      if($result->num_rows > 0) {
                        $totalno = $result->num_rows;
                      } else {
              ...
              <div class="col-md-6">
                <div class="info-box bg-c-yellow">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text">Unqualified</span>
                    <?php
                      $sql = "SELECT * FROM users WHERE qualification NOT IN ('Bachelor\'s Degree', 'PHD', 'Masters', 'Bachelors Degree');";
                      ;
                      $result = $conn->query($sql);
                      if($result->num_rows > 0) {
                        $totalno = $result->num_rows;
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
       <strong>Copyright &copy; 2023 <a href="#">online recruitment applications</a>.</strong> All rights reserved.
    </div>
  </footer>
