...
if(isset($_POST)) {
	...
	$stmt = $conn->prepare("INSERT INTO job_post(id_company, jobtitle, description, minimumsalary, maximumsalary, experience, qualification, education, skills) VALUES (?,?, ?, ?, ?, ?, ?, ?, ?)");

	$stmt->bind_param("issssssss", $_SESSION['id_company'], $jobtitle, $description, $minimumsalary, $maximumsalary, $experience, $qualification, $education,$skills);
