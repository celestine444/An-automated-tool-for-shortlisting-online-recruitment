...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-lg"><b>Company</b> Portal</span>
    </a>
            ...
            <div class="row">
              <form method="post" action="addpost.php">
                ...
                <input type="number" class="form-control  input-lg" id="experience" autocomplete="off" name="experience" placeholder="Experience (in Years) Required" required="">
                  ...
                  <div class="form-group">
                  <input type="text" name="education" class="form-control  input-lg" placeholder="Education" required=""><br>
                  </div>

                  <div class="form-group">
                  <input type="text"  class="form-control  input-lg" name="skills" placeholder="Skills" required="">
