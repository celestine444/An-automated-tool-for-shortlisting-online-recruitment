...
<div class="wrapper">
          ...
          <form method="post" id="registerCandidates" action="adduser.php" enctype="multipart/form-data">
            <div class="col-md-6 latest-job ">
              ...
              <div class="form-group">
                ...
                <input class="form-control input-lg" type="date" id="dob" min="1960-01-01" max="2006-01-31" name="dob" placeholder="Date Of Birth">
              </div>
              <div class="form-group">
              ...
              <input id="qualification" name="qualification" class="form-control"  placeholder="Qualification">
                
              </div>
              <div class="form-group">
                <input class="form-control input-lg" type="text" id="stream" name="stream" placeholder="Grade">
              </div>                    
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
       <strong>Copyright &copy; 2023 <a href="#">online recruitment applications
    </div></a>.</strong> All rights reserved.
    </div>
  </footer>
